    ...
    <form role="form" action="{{route('content.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="discription" class="form-control" placeholder="توضیحات را وارد کنید"  value="{{ old('discription')}}">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="tags" class="form-control" placeholder="لینک را وارد کیند را وارد کنید"  value="{{ old('tags')}}">
          </div>
